                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Today's Date <small> <?php echo date("Y-m-d"); ?> </small>
                        </h1>
                    </div>
    ...
    <div class="col-md-12"> 
      ...
      <div class="card">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa-home"></i>  <span>Today's Meal list</span><span class="badge"><?php echo $number ; ?></span></a></li>
