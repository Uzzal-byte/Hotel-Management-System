...
<head>
  <meta charset="UTF-8">
  <title>ROOM SHARING ADMIN</title>
...
<body style="background-color:#6fb3b980;">
			...
			<div class="col-md-5 col-md-offset-4">
					<div class="card">
						  <div class="cardHeader">
							...
							<h3 style="color:green;text-align:center;margin-left:60px;">Admin Login</h3>
						  </div>
