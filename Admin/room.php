						...
						while($row= mysqli_fetch_array($re))
							...
							<?php
							 ...
							 if(isset($_POST['add']))
							 {
										...
										$sql ="INSERT INTO `add_room`( `name`, `hotel_id`,`price`, `wifi`,`ac`,`ac_per_day`, `body_message`,`body_message_per_day`, `meal`,`meal_per_day`,`image`,`bed_cost`) VALUES ('$roomname','$hotelname','$price','$wifi','$ac','$ac_price','$body_massage','$body_massage_price','$meal','$meal_price','$file_name','$bedcost')" ;
