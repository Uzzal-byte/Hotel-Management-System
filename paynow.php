             ...
             ?>
				...
				<div class="col-md-6 ">
                    ...
                    <div class="panel panel-info">
						...
						<b>You will earn : BDT</b> <?php echo $earn;?> TK<br>
                    ...
                    <div class="panel panel-primary">
						...
						<h3 style="color:red;"> Pay The due amount to this bkash number ( 01718825371    )  </h3>
						<b> Due amount:  BDT </b> <?php echo $total;?> TK <br>
						...
						<input type="text" name="accnmbr" value="" class="form-control">
						</div>
						
						<div class="form-group">
						<label> Transaction id </label>
						<input type="text" name="tnxid" value="" class="form-control">
						</div>
						
						<div class="form-group">
						
						<center> <input type="submit" name="paynow" value="Confirm Payment" class="btn btn-primary" > </center>
						</div>
